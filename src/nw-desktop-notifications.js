(function(){
	...
	function appendNotificationToWindow(options, onClick) {
        ...
        jqBody.find('.title').click(function(e) {
            return eventHandler(e, elemId, onClick);
        });
        jqBody.find('.description').click(function(e) {
            return eventHandler(e, elemId, onClick);
        });
        ...
        // gallery specific
        if (options.type == 'image') {
            jqBody.find('.gallery').find('.title').click(onClick);
            jqBody.find('.gallery').find('img').click(onClick);
        }
        return dfd.promise();
	}
